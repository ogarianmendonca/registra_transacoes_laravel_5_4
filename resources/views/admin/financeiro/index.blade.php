...
@section('content')
    ...
    <div class="row">
        <div class="col-md-6">
            <a href="{{ route('admin.financeiro.recarga') }}" class="btn btn-primary"><i class="fas fa-plus"></i>
                Recarregar</a>

            @if($saldo_total > 0)
                <a href="{{ route('admin.financeiro.saque') }}" class="btn btn-danger"><i class="fas fa-minus"></i>
                    Sacar</a>

                <a href="{{ route('admin.financeiro.transfere') }}" class="btn btn-info"><i
                            class="fas fa-exchange-alt"></i> Transferir</a>
            @endif
        </div>
    </div>
